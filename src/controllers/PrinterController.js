...
const PrintersDepartmentsModel = require('../../models/PrintersDepartments');
const PrintersModel = require('../../models/Printers');
...
exports.printerCreate = async (req, res) => {
    ...
    try {
        ...
        const novaPrinter = {
            printerName: req.body.data.nome.toUpperCase(),
    ...
    try {
        ...
        const printer = await PrintersModel.findOne({
            where: { printerName: req.body.data.nome },
            ...
            include: [
              {
                ...
                where: {
                  idDept: Sequelize.col('PrintersDepartments.idDept')
                },
