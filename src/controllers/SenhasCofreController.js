    ...
    const tableHtml = `
        <style>
            ...
            table {
                ...
                height: calc(100% - 20px); /* heigh da tabela menos a margem de 10px em cada lado */
                margin: 0 0 20px 0; /* Centralizar a tabela */
                font-size: 11px;
        ...
        <table style="width: 100%; margin: 0px 0px 10px 0px; font-size: 10px; border-collapse: collapse;">
            <thead>
            <tr>
                ...
                <th border: 1px solid #ddd; padding: 2px 6px; text-align: left;">MFA</th>
            ...
            ${tableData.map(row => `
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; padding: 2px 6px; text-align: left;">${row.mfa}</td>
